...
(function (root) {
  ...
  // [ref metre, nom, unite, heures/unite, materiau, qte materiau/unite, materiel/unite, mots cles]
  const ouvrages = [
  ...
  ].map(([ref, nom, unite, heures, materiau, quantiteMateriau, materiel, motsCles]) => ({
    ref,
    nom,
    unite,
    heures,
